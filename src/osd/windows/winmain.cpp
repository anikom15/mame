...
const options_entry windows_options::s_option_entries[] =
{
	...
	// Signal controls
	{ nullptr,                                                  nullptr,             OPTION_HEADER,     "SIGNAL COLOR POST-PROCESSING OPTIONS" },
	{ WINOPTION_COLOR_SPACE";fs_color",                         "0",                 OPTION_INTEGER,    "color space of simulated display" },
	{ WINOPTION_SATURATION";fs_sat(0.0-4.0)",                   "1.0",               OPTION_FLOAT,      "saturation scaling value" },
	{ WINOPTION_TINT";fs_tint(-180-180)",                       "0.0",               OPTION_FLOAT,      "Tint phase offset (degrees)" },
	{ WINOPTION_SCALE";fs_scale(0.0-2.0)",                      "1.0,1.0,1.0",       OPTION_STRING,     "signal scaling value (multiplicative)" },
	{ WINOPTION_OFFSET";fs_offset(-1.0-1.0)",                   "0.0,0.0,0.0",       OPTION_STRING,     "signal offset value (additive)" },
	...
	{ nullptr,                                                  nullptr,             OPTION_HEADER,     "DISPLAY TRANSFER POST-PROCESSING OPTIONS" },
	{ WINOPTION_SRGB_GAMMA_ENABLE";fs_srgb",                    "1",                 OPTION_BOOLEAN,    "Use special gamma correction for sRGB systems" },
	{ WINOPTION_DISPLAY_GAMMA";fs_sgamma",                      "2.4",               OPTION_FLOAT,      "exponent applied to signal by the display" },
	...
	{ WINOPTION_PHOSPHOR_BETA";fs_phosbeta",                    "2.0,2.0,2.0",       OPTION_STRING,     "exponent used for inverse power phosphor decay model" },
	// Bloom
	...
	// Geometry
	{ nullptr,                                                  nullptr,             OPTION_HEADER,     "SCREEN GEOMETRY POST-PROCESSING OPTIONS" },
